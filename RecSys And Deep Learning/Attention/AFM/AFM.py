    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope('linear_part'):
                weights['linear_w'] = tf.Variable(tf.random_uniform([self.feature_size, 1], 0.0, 1.0),name='linear_w')
                self.linear_part = tf.nn.embedding_lookup(weights['linear_w'],self.feature_index)  # [None, field_size, 1]
